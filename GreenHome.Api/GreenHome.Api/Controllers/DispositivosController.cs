...
namespace GreenHome.Api.Controllers
{
    ...
    public class DispositivosController : ControllerBase
    {
        ...
        public DispositivosController(IDispositivoService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Criar([FromBody] CriarDispositivoDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Atualizar(string id, [FromBody] AtualizarDispositivoDto dto)
        {
